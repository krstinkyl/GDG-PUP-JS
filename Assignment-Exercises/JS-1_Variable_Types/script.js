...
// Using let
let name =  "User"; // Define a string here, e.g., "Juan Cruz"
let age = 22; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["reading", "crocheting", "codings"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["House in the Cerulean Sea", "Babel", "Under the Whispering Door"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 26; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["pink", "blue", "white"]; // Define an array here, e.g., ["red", "green", "blue"]
